...
final public class AQUtils {
    ...
    static func showAlert(message: String, okTitle: String) {
        ...
        if let popoverPresentationController = alert.popoverPresentationController {
            ...
            popoverPresentationController.sourceRect = CGRect(x: topView?.view.bounds.midX ?? 0, y: topView?.view.bounds.midY ?? 0, width: 0, height: 0)
        }
    ...
    ///   - message: Alert message
    ///   - style: Alert style
    static func showAlertAndWaitForAction(title: String, message: String, cancelButton: String, style: UIAlertController.Style, actionClicked: @escaping () -> Void) {
        let topView = UIApplication.topViewController() ?? UIViewController()
        let alert = UIAlertController(title: title, message: message, preferredStyle: style)
        alert.addAction(UIAlertAction(title: cancelButton, style: .default, handler: { _ in
            actionClicked()
    ...
    ///   - message: Alert message
    ///   - style: Alert style
    static func showAlertWithActionAndDismiss(title: String? = nil, message: String? = nil, style: UIAlertController.Style, dismissTitle: String, actionTitle: String, actionClicked: @escaping () -> Void) {
        let topView = UIApplication.topViewController() ?? UIViewController()
        let alert = UIAlertController(title: title, message: message, preferredStyle: style)
    ...
    static func showAlertWith2ActionsAndDismiss(title: String? = nil, message: String? = nil, style: UIAlertController.Style, dismissTitle: String, action1Title: String, action2Title: String, actionClicked: @escaping (_ index: Int) -> Void) {
        let topView = UIApplication.topViewController() ?? UIViewController()
        let alert = UIAlertController(title: title, message: message, preferredStyle: style)
        ...
        alert.addAction(UIAlertAction(title: action2Title, style: .default, handler: { _ in
            actionClicked(2)
        }))
        alert.addAction(UIAlertAction(title: dismissTitle, style: .cancel, handler: { _ in
    ...
    static func showAlertWith3ActionsAndDismiss(title: String, message: String, style: UIAlertController.Style, dismissTitle: String, action1Title: String, action2Title: String, action3Title: String, actionClicked: @escaping (_ index: Int) -> Void) {
        let topView = UIApplication.topViewController() ?? UIViewController()
        let alert = UIAlertController(title: title, message: message, preferredStyle: style)
        ...
        alert.addAction(UIAlertAction(title: action3Title, style: .default, handler: { _ in
            actionClicked(3)
        }))
        alert.addAction(UIAlertAction(title: dismissTitle, style: .cancel, handler: { _ in
    ...
    static func showAlertWith4ActionsAndDismiss(title: String, message: String, style: UIAlertController.Style, dismissTitle: String, action1Title: String, action2Title: String, action3Title: String, action4Title: String, actionClicked: @escaping (_ index: Int) -> Void) {
        let topView = UIApplication.topViewController() ?? UIViewController()
        let alert = UIAlertController(title: title, message: message, preferredStyle: style)
        ...
        alert.addAction(UIAlertAction(title: action4Title, style: .default, handler: { _ in
            actionClicked(4)
        }))
        alert.addAction(UIAlertAction(title: dismissTitle, style: .cancel, handler: { _ in
